...
function showCart() {
    ...
    let uniqueArray = [...uniqueItems] // ... spread
    ...
    cartItems.map(ci => {
        // Hente produktinformasjon fra legodudes.js products
        ...
        `
            <tr>
                ...
                <td class="price">NOK ${product.price},-</td>
                <td class="quantity">Antall: ${ci.quantity}</td>
